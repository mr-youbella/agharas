	...
	return (
		<div className="bg-white">
			<nav className="p-4 flex text-black justify-between xl:w-1/2 mx-auto">
				<Link href="/"><h1 className="mr-auto md:text-center text-3xl font-bold text-[#E4694E] cursor-pointer">BlassaReviews</h1></Link>
				<ul className="sm:flex gap-5 items-center hidden">
					...
					<Link href="About"><li className="text-base font-bold bg-[#E4694E] p-2 rounded-2xl px-4 text-white cursor-pointer hover:bg-[#e4644e]">About</li></Link>
				</ul>
