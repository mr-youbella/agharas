...
export default function FormReport()
{
	...
	return (
		<form className="flex flex-col bg-white shadow-[0_0_10px] shadow-black/30 rounded-2xl w-full mt-10 text-left p-7">
			...
			<textarea className="bg-[#FFFBF7] border border-gray-300 rounded-xl p-2 mt-1 placeholder:text-gray-400" placeholder="Describe the issue in detail. What's wrong? How does it affect the community?" required />
