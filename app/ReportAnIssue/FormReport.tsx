...
export default function FormReport()
{
	...
	return (
		<form className="flex flex-col bg-white shadow-[0_0_10px] shadow-black/30 rounded-2xl w-full mt-10 text-left p-7">
			...
			<input type="text" className="bg-[#FFFBF7] border border-gray-300 rounded-xl p-2 mt-2 placeholder:text-gray-400" placeholder="e.g., Large pothole on Main Street" required/>
			...
			<textarea className="bg-[#FFFBF7] border border-gray-300 rounded-xl p-2 mt-1 placeholder:text-gray-400 h-30" placeholder="Describe the issue in detail. What's wrong? How does it affect the community?" required />
			...
			<label htmlFor="image" className="border border-dashed border-[#E4694E] p-5 text-center rounded-2xl mt-3 cursor-pointer hover:bg-[#E4694E]/10">
				...
				<input id="image" className="hidden" type="file" accept=".png, .jpg" required/>
			</label>
			<div className="flex flex-col md:flex-row gap-4">
				<div className="flex-1 flex flex-col">
					...
					<input type="text" className="bg-[#FFFBF7] border border-gray-300 rounded-xl p-2 mt-1 placeholder:text-gray-400" placeholder="e.g., 123 Main Street, Marrakech" required/>
				</div>
				<div className="flex-1 flex flex-col">
